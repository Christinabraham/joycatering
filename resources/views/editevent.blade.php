...
<div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4 ">
 ...
 <tr>
     ...
     <tr>
     <td><input value="{{$info->eid}}" name="eid" type="text" class="form-control"></td>
     <td><input value="{{$info->ename}}" name="ename" type="text" class="form-control"></td>
     <td><input value="{{$info->eprice}}" name="eprice" type="text" class="form-control"></td>
