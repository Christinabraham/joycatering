...
<div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4 ">
 ...
 <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4 ">
 <br><br>
 <form action="/upfood" method="post">
 @csrf
 ...
 <tr>
    ...
    <td><input type="hidden" name="id"  value="{{$info->id}}"/></td>
     ...
     <tr>
     <td><input value="{{$info->fid}}" name="fid" type="text" class="form-control"></td>
     <td><input value="{{$info->fname}}" name="fname" type="text" class="form-control"></td>
     <td><input value="{{$info->fprice}}" name="fprice" type="text" class="form-control"></td>
