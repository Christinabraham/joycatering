...
<body background="https://img.wallpapersafari.com/desktop/1280/1024/49/61/Eda7O1.jpg"  style="height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
...
<nav class="navbar navbar-expand-lg navbar-style="color:rgba(247, 247, 248, 0.911) bg-dark" >
    <div class="container-fluid" style="font-family:courier;">
      ...
      <a class="navbar-brand" href="/" style="font-family:verdana;color:yellow" > Joy </a>
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/" style="font-family:courier;">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/cv">View Item</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="/cg">Gallery</a>
          </li>
          <li class="nav-item">
        ...
        <form class="d-flex">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/l">SIGN IN</a>
                </li>
            </ul>
        </form>
      </div>
  ...
  <br><br>
    <div class="container">
                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active" data-bs-interval="10000">
                        <img height="600px" width="600px" src="https://cdn.lifestyleasia.com/wp-content/uploads/sites/3/2020/05/04113706/monika-grabkowska-P1aohbiT-EY-unsplash-1350x900.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        <h5  style="color:white">Joy Wallace Catering</h5>
                         
                        </div>
                      </div>
                      <div class="carousel-item" data-bs-interval="2000">
                        <img height="600px" width="600px"  src="https://wallpapercave.com/wp/wp4441393.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        <h5  style="color:black">Joy Wallace Catering</h5>
                        </div>
                      </div>
        ...
        <div class="row">
                    ...
                    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                    <img src="https://www.w3schools.com/w3images/sandwich.jpg" alt="Sandwich" style="width:70%" height="60%">
                    <h3 style="color:white" >The Perfect Sandwich, A Real NYC Classic</h3>
                    <p style="color:white">Just some random text, lorem ipsum text praesent tincidunt ipsum lipsum.</p>
               </div>
                    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                    <img src="https://www.w3schools.com/w3images/steak.jpg" alt="Steak" style="width:70%" height="60%">
                    <h3 style="color:white">Let Me Tell You About This Steak</h3>
                    <p style="color:white">Once again, some random text to lorem lorem lorem lorem ipsum text praesent tincidunt ipsum lipsum.</p>
               </div>
               <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">

               <img src="https://www.w3schools.com/w3images/cherries.jpg" alt="Cherries" style="width:70%" height="60%">
      <h3 style="color:white">Cherries, interrupted</h3>
      <p style="color:white">Lorem ipsum text praesent tincidunt ipsum lipsum.</p>
      <p style="color:white">What else?</p>
    </div>
    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">
    <img src="https://www.w3schools.com/w3images/wine.jpg" alt="Pasta and Wine" style="width:70%" height="60%">
      <h3 style="color:white">Once Again, Robust Wine and Vegetable Pasta</h3>
      <p style="color:white">Lorem ipsum text praesent tincidunt ipsum lipsum.</p>
    </div>
            ...
            <div class="row">
                    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">
                    <img src="https://www.w3schools.com/w3images/popsicle.jpg" alt="Popsicle" style="width:70%" height="60%">
      <h3 style="color:white">All I Need Is a Popsicle</h3>
      <p style="color:white">Lorem ipsum text praesent tincidunt ipsum lipsum.</p>
    </div>
    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">

    <img src="https://www.w3schools.com/w3images/salmon.jpg" alt="Salmon" style="width:70%" height="60%">
      <h3 style="color:white">Salmon For Your Skin</h3>
      <p style="color:white">Once again, some random text to lorem lorem lorem lorem ipsum text praesent tincidunt ipsum lipsum.</p>
    </div>
    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">
    <img src="https://www.w3schools.com/w3images/sandwich.jpg" alt="Sandwich" style="width:70%" height="60%">
      <h3 style="color:white">The Perfect Sandwich, A Real Classic</h3>
      <p style="color:white">Just some random text, lorem ipsum text praesent tincidunt ipsum lipsum.</p>
    </div>
    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3">
    <img src="https://www.w3schools.com/w3images/croissant.jpg" alt="Croissant" style="width:70%" height="60%">
      <h3 style="color:white">Le French</h3>
      <p style="color:white">Lorem lorem lorem lorem ipsum text praesent tincidunt ipsum lipsum.</p>
    </div>
  </div>
        ...
        <br><br>
                <div class="row">
                    <div class="col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                        ...
                        <img height="200" width="200" src ="https://www.wallpapers4u.org/wp-content/uploads/meat_vegetables_decoration_catering_70139_1920x1080.jpg" alt="" class="src">
                        <br><br>
                        <h4 style="font-family:verdana;color:rgb(114, 116, 114);">UNBELIEVABLE FOOD</h4>
                        <p style="color: rgb(192, 188, 188);">
                            
                            Our catering creations are a deep form of love we live to share with people. Whether it's an hors d'oeuvre or an extravagant spread, you'll taste the passion in every bite.
                        </p>
                        
                        <h4 style="font-family:verdana;color:rgb(114, 116, 114);">INSPIRED PRESENTATION</h4>
                        <p style="color: rgb(192, 188, 188);">
                            
                            The most memorable culinary experiences are those that inspire. We will collaborate with you to create custom builds and engaging presentations.
                        </p>
                        <h4 style="font-family:verdana;color:rgb(114, 116, 114);">ONE-OF-A-KIND EXPERIENCE</h4>
                        <p style="color: rgb(192, 188, 188);">
                            
                            Bring on the fun! We’re all about learning what makes you feel joy and turning it into an extraordinary affair everyone remembers for years to come.                        </p>

                    </div>
                    
                    <div class="col col-12 col-sm-6 col-md-6 col-lg-8 col-xl-8 col-xxl-8">
                        <br>
                        <h4 style="font-family:verdana;color:rgb(114, 116, 114);">TASTE MIAMI</h4>
                        <p style="color: rgb(192, 188, 188);">
                            Joy Wallace Catering has been revered as one of Miami’s most trusted catering & event companies for over 30 years. We’re a culturally diverse team of travelers inspired by cuisines across the globe.</p><br><br>
                            <img height="500" width="800" src ="https://chefstableware.co.uk/wp-content/uploads/2016/03/untitled-3-of-102-1024x682.jpg" alt="" class="src">
                ...
                <div class="row">
                    ...
                    <div class="col col-12 col-sm-6 col-md-6 col-lg-8 col-xl-3 col-xxl-2"> </div>
                        <br>
                        <div class="col col-12 col-sm-6 col-md-6 col-lg-8 col-xl-8 col-xxl-8">
                       <center> <h4 style="font-family:verdana;color:rgb(114, 116, 114);">CLIENTS</h4>
                        <p style="color: rgb(192, 188, 188);">
                            From past presidents to sports teams,<br> we’ve worked with prestigious people and brands.<br> Status aside, we treat each client to<br> the ultimate Miami Catering experience.</p><br><br>
                            <img height="500" width="700" src ="https://i.pinimg.com/originals/93/93/72/939372681920d0e5f3f50b50eaf8819c.jpg" alt="" class="src"></center>
            ...
            <div class="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                <br>
                <br>
                <h6 style="font-family:verdana;color:rgb(127, 131, 127);">USEFUL LINKS</h6>
                <table class="table table-borderless">
                    <tr><td><a class="navbar-brand" href="/">Home</a></td></tr>  
                    <tr><td><a class="navbar-brand" href="/cv">View Item</a></td></tr>
                    <tr><td><a class="navbar-brand" href="/cg">Gallery</a></td></tr>
                    <tr><td><a class="navbar-brand" href="/cc">Contact</a></td></tr>
                </table>
                    </div>
                    <div class="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                        <br>
                        <br>
                        <h6 style="font-family:verdana;color:rgb(146, 143, 143);">CONTACT US</h6>
                        <table class="table table-borderless" style="font-family:courier;">
                            <tr><td><a class="navbar-brand" href="" >  Joy Wallace Catering<br>
                                8501 SW 129 Terrace<br>
                                Miami, FL 33156<br>
                                305.252.0020<br></a></td></tr>  
