...
<body background="https://img.wallpapersafari.com/desktop/1280/1024/49/61/Eda7O1.jpg"  style="height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
    ...
    <center ><h1 style="color:rgba(139, 139, 143, 0.911)"><u>CONTACT US</u></h1></center> 
   ...
   <div class="container">
       ...
       <div class="row">
        ...
        <div class="col col-12 col-sm-7 col-md-7 col-lg-7 col-xl-6 col-xxl-6">
            <img src="https://png.pngtree.com/thumb_back/fh260/background/20190222/ourmid/pngtree-crayfish-food-food-condiment-black-horizontal-banner-goodsseasoningblackhorizontal-bannerdelicious-image_50376.jpg" alt="">
        
               <h4 style="color:rgba(182, 179, 179, 0.911)"><b>CONTACT INFO</b></h4>
               <address style="font-family:courier;">
                <b style="color:rgba(182, 179, 179, 0.911)">
    ...
    <div class="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
        <br>
        <br>
        <h6 style="font-family:verdana;color:rgb(183, 189, 183);">USEFUL LINKS</h6>
        <table class="table table-borderless">
            ...
            <div class="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-3">
                <br>
                <br>
                <h6 style="font-family:verdana;color:rgb(211, 202, 202);">CONTACT US</h6>
                <table class="table table-borderless">
