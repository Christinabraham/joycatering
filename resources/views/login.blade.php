...
<body background="https://img.wallpapersafari.com/desktop/1280/1024/49/61/Eda7O1.jpg"  style="height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
  ...
  <div class="container">
   ...
   <div class="col">
    <h2 style="color:rgba(139, 139, 143, 0.911)"><center>LOGIN</center></h2>
    @if(count($errors)>0)
    ...
    <table  class="table table-borderless" >
     <tr>
         <td style="color:rgba(139, 139, 143, 0.911)">Username</td>
         <td><input type="text" name="username"  class="form-control"></td>
     </tr>
     <tr>
         <td style="color:rgba(139, 139, 143, 0.911)">Password</td>
         <td><input type="password" name="psw"  class="form-control"></td>
     </tr>
     <tr>
         <td></td>
         <td>
         <a href="/reg" class="btn btn-outline-primary">Sign Up</a>
         <button class="btn btn-outline-primary">Login</button></td> 
