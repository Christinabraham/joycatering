...
<body background="https://img.wallpapersafari.com/desktop/1280/1024/49/61/Eda7O1.jpg"  style="height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-style="color:rgba(247, 247, 248, 0.911) bg-dark">
     ...
     <center><h1 style="color:rgba(161, 161, 167, 0.911)"><u>GALLERY</u></h1></center><br>
    <div class="container">

        <div class="row">
            <div class="col col-12 col-sm-12 col-md-9 col-lg-6 col-xl-6 col-xxl-6">
                <table class="table table-borderless">
                    <tr>
                        <td><img src="https://images.unsplash.com/photo-1525265332434-d52e2314161d?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2F0ZXJpbmd8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80" height="200px" width="400px"></td>
                    <td><img src="https://images.unsplash.com/photo-1592593130597-c44b22dfdec5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80" height="200px" width="400px"></td>
                    <td><img src="https://forkliftcatering.com/wp-content/uploads/2019/01/forklift-catering-press-wedding-lovely-WarehouseXI-styledshoot-095-1024x683.jpg" height="200px" width="400px"></td>
                    </tr>
                    <tr>
                        <td><img src="https://images.all-free-download.com/images/graphicthumb/food_picture_03_hd_pictures_167556.jpg" height="200px" width="400px"></td>
                        <td><img src="https://image.freepik.com/free-photo/close-up-fast-food-meal_23-2148273062.jpg" height="200px" width="400px"></td>
                        <td><img src="https://image.freepik.com/free-photo/chicken-nuggets-kfc-style-with-french-fries-mayonnaise-ketchup-vegetable-salad_114579-907.jpg" height="200px" width="400px"></td>
                    </tr>
                    <tr>
                        <td><img src="https://wallpapercave.com/wp/wp7781512.jpg" height="200px" width="400px"></td>
                        <td><img src="https://i.pinimg.com/originals/fc/07/4f/fc074fa6d5aa4ca06a930659c9dcde85.jpg" height="200px" width="400px"></td>
                        <td><img src="https://i.pinimg.com/originals/47/15/6d/47156d8aa470b276c3ee0e4ebf08ff03.jpg" height="200px" width="400px"></td>
                    </tr>
                    <tr>
                        <td><img src="https://ak.picdn.net/shutterstock/videos/24678605/thumb/1.jpg" height="200px" width="400px"></td>
                        <td><img src="https://upserve.com/media/sites/2/catering.jpg" height="200px" width="400px"></td>
                        <td><img src="https://wallpapercave.com/wp/wp7781761.jpg" height="200px" width="400px"></td>
                    </tr>
        ...
        <div class="row" style="font-family:courier;">
            ...
            <div class="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                <br>
                <br>
                <h6 style="font-family:verdana;color:rgb(149, 153, 149);">USEFUL LINKS</h6>
                <table class="table table-borderless">
            ...
            <div class="col col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                <br>
                <br>
                <h6 style="font-family:verdana;color:rgb(160, 155, 155);">CONTACT US</h6>
                <table class="table table-borderless">
