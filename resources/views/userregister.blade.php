...
{{ csrf_field() }}
<h2 style="color:rgba(182, 179, 179, 0.911)"><center>SIGN UP</center></h2>
    <table  class="table table-borderless">
    <tr>
        <td style="color:rgba(182, 179, 179, 0.911)">Name</td>
        <td><input type="text" name="name" value="{{old('name')}}" class="form-control">
        <span class="text-danger">@error('name'){{$message}} @enderror  </span>
        </td>
    </tr>
    <tr>
        <td style="color:rgba(182, 179, 179, 0.911)">Username</td>
        <td><input type="text" name="username" value="{{old('username')}}" class="form-control">
        <span class="text-danger">@error('username'){{$message}} @enderror  </span>
        </td>
    </tr>
     <tr>
         <td style="color:rgba(182, 179, 179, 0.911)">Email</td>
         <td><input type="text" name="email" value="{{old('email')}}" class="form-control">
         <span class="text-danger">@error('email'){{$message}} @enderror  </span>
         </td>
     </tr>
     <tr>
         <td style="color:rgba(182, 179, 179, 0.911)">Phone NO</td>
         <td><input type="text" name="phnno" value="{{old('phnno')}}" class="form-control">
         <span class="text-danger">@error('phnno'){{$message}} @enderror  </span>
         </td>
     </tr>
     <tr>
        <td style="color:rgba(182, 179, 179, 0.911)">Address</td>
        <td><input type="text" name="ads" value="{{old('ads')}}" class="form-control">
        <span class="text-danger">@error('ads'){{$message}} @enderror  </span>
        </td>
    </tr>
    <tr>
        <td style="color:rgba(182, 179, 179, 0.911)">Password</td>
        <td><input type="password" name="psw" class="form-control">
        <span class="text-danger">@error('psw'){{$message}} @enderror  </span>
        </td>
    </tr>
     <tr>
         <td style="color:rgba(182, 179, 179, 0.911)">Confirm Password</td>
         <td><input type="password" name="cpsw" class="form-control">
         <span class="text-danger">@error('cpsw'){{$message}} @enderror  </span>
         </td>
     </tr>
     <tr>
         <td></td>
         <td><button class="btn btn-outline-primary">SIGNUP</button></td>
     </tr>
 </table> 
</form>
